...
function onUse(cid, item, frompos, item2, topos)
	if (item.itemid == ITEM_WHEAT and isIntegerInArray(ITEM_MILL, item2.itemid)) then
	...
	elseif(item.itemid == ITEM_DOUGH and isIntegerInArray(OVEN_ON, item2.itemid)) then
